 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class VarNumIntSignLeadingComp0 extends VarNum
{
	VarNumIntSignLeadingComp0(DeclareType9 declareType9)
	{
		super(declareType9);
	}
	
	protected VarNumIntSignLeadingComp0()
	{
		super();
	}
	...
	{
		VarNumIntSignLeadingComp0 v = new VarNumIntSignLeadingComp0();
		return v;
	}
	...
	{
		return VarType.VarNumIntSignLeadingComp0;
	}
}
