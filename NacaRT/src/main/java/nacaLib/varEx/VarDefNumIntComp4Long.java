 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class VarDefNumIntComp4Long extends VarDefNum
{
	/**
	 * 
	 */
	...
	protected VarDefNumIntComp4Long()
	{
		super();
	}
	
//	VarDefNumIntComp4Long(VarDefNumIntComp4Long varDefSource)
//	{
//		super(varDefSource);
...
//	{
//		return new VarDefNumIntComp4Long(this);
//	}
	...
	{	
		long l = internalReadIntSignComp4AsLongWithMaxDigits(this, buffer, m_nNbDigitInteger);
		CStrNumber csNum = TempCacheLocator.getTLSTempCache().getCStrNumber();
		csNum.valueOf(l);		
		return csNum;
	}
...
//	}
	...
	{
		writeIntComp4AsLong(buffer, nOffset, 0L);
...
//	}
	...
	{
		writeIntComp4AsLong(buffer, nOffset, n);
	}
	...
	private int writeIntComp4AsLong(VarBufferPos buffer, long l)
	{
		if(l < 0)
			l = -l;
	...
	private int writeIntComp4AsLong(VarBufferPos buffer, int nOffset, long l)
	{
		if(l < 0)
			l = -l;
		int nBinaryNumberStorage = getSingleItemRequiredStorageSize();
...
//		String cs2 = getStringRightPadded(n2, ' ', varDef1.getTotalSize());
	...
	{
		return VarTypeId.VarDefNumIntComp4LongTypeId;
	}
	...
	{
		VarDefNumIntComp4Long varDefCopy = (VarDefNumIntComp4Long)varDefBufferCopySingleItem;
