 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class VarNumDecComp4 extends VarNum
{
	VarNumDecComp4(DeclareType9 declareType9)
	{
		super(declareType9);
	}
	
	protected VarNumDecComp4()
	{
		super();
	}
	...
	{
		VarNumDecComp4 v = new VarNumDecComp4();
		return v;
	}
