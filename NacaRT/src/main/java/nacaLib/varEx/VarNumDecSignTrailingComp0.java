 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class VarNumDecSignTrailingComp0 extends VarNum
{
	VarNumDecSignTrailingComp0(DeclareType9 declareType9)
	{
		super(declareType9);
	}
	
	protected VarNumDecSignTrailingComp0()
	{
		super();
	}
	...
	{
		VarNumDecSignTrailingComp0 v = new VarNumDecSignTrailingComp0();
		return v;
	}
	...
	{
		return VarType.VarNumDecSignTrailingComp0;
	}
}
