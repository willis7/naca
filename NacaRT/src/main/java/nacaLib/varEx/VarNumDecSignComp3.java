 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class VarNumDecSignComp3 extends VarNum
{
	VarNumDecSignComp3(DeclareType9 declareType9)
	{
		super(declareType9);
	}
	
	protected VarNumDecSignComp3()
	{
		super();
	}
	...
	{
		VarNumDecSignComp3 v = new VarNumDecSignComp3();
		return v;
	}
	...
	{
		return VarType.VarNumDecSignComp3;
	}
}
