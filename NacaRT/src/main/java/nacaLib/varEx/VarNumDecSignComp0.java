 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class VarNumDecSignComp0 extends VarNum
{
	VarNumDecSignComp0(DeclareType9 declareType9)
	{
		super(declareType9);
	}
	
	protected VarNumDecSignComp0()
	{
		super();
	}
	...
	{
		VarNumDecSignComp0 v = new VarNumDecSignComp0();
		return v;
	}
	...
	{
		return VarType.VarNumDecSignComp0;
	}
}
