 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class VarDefNumIntComp3Long extends VarDefNum
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	public VarDefNumIntComp3Long(VarDefBase varDefParent, DeclareType9 declareType9, NumericValue numericValue)
	{
		super(varDefParent, declareType9.m_varLevel);
		m_nNbDigitInteger = numericValue.m_nNbDigitInteger;
	}
	
	protected VarDefNumIntComp3Long()
	{
		super();
	}
	
//	VarDefNumIntComp3Long(VarDefNumIntComp3Long varDefSource)
//	{
//		super(varDefSource);
...
//	{
//		return new VarDefNumIntComp3Long(this);
//	}
	
	protected VarDefBuffer allocCopy()
	{
		VarDefNumIntComp3Long v = new VarDefNumIntComp3Long();
...
//	}
	...
	{
		long l = Pic9Comp3BufferSupport.getAsUnsignedLong(buffer, m_nNbDigitInteger, m_nTotalSize);
	...
	{	
		long l = Pic9Comp3BufferSupport.getAsLongWithMaxNbdigits(this, buffer, m_nNbDigitInteger, m_nTotalSize);
		CStrNumber csNum = TempCacheLocator.getTLSTempCache().getCStrNumber();
		csNum.valueOf(l);		
		return csNum;
	}
	...
	void write(VarBufferPos buffer, char c)
	{
		...
		Pic9Comp3BufferSupport.setFromRightToLeftUnsignedLong(buffer, m_nNbDigitInteger, m_nTotalSize, n);
		//writeIntComp3AsLong(buffer, n, m_nNbDigitInteger);
	}
	...
	{
		Pic9Comp3BufferSupport.setFromRightToLeftUnsignedLong(buffer, m_nNbDigitInteger, m_nTotalSize, (long)d);
		//writeIntComp3AsLong(buffer, (long)d, m_nNbDigitInteger);
	}
	
	void write(VarBufferPos buffer, Dec dec)
	{
		Pic9Comp3BufferSupport.setFromRightToLeftUnsignedLong(buffer, m_nNbDigitInteger, m_nTotalSize, dec.getSignedLong());
		//writeIntComp3AsLong(buffer, dec.getSignedLong(), m_nNbDigitInteger);
	}
	...
	{
		Pic9Comp3BufferSupport.setFromRightToLeftUnsignedLong(buffer, m_nNbDigitInteger, m_nTotalSize, 0L);
		//writeIntComp3AsLong(buffer, 0L, m_nNbDigitInteger);
	}
...
//	}
	...
	{
		Pic9Comp3BufferSupport.setFromRightToLeftOffsetUnsignedLong(buffer, m_nNbDigitInteger, m_nTotalSize, nOffset, 0L);
		//writeIntComp3AsLong_TOTO(buffer, nOffset, 0L, m_nNbDigitInteger);
...
//	}
	...
	{
		Pic9Comp3BufferSupport.setFromRightToLeftOffsetUnsignedLong(buffer, m_nNbDigitInteger, m_nTotalSize, nOffset, (long)n);
		//writeIntComp3AsLong_TOTO(buffer, nOffset, n, m_nNbDigitInteger);
	}
...
//		String cs2 = getStringRightPadded(n2, ' ', varDef1.getTotalSize());
	...
	{
		return VarTypeId.VarDefNumIntComp3LongTypeId;
	}
	...
	{
		VarDefNumIntComp3Long varDefCopy = (VarDefNumIntComp3Long)varDefBufferCopySingleItem;
