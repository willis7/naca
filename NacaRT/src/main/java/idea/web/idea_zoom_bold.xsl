...
function doOnload()
{
	<xsl:if test="//form/@customOnload!=''">
	<xsl:value-of select="//form/@customOnload"/>();
	</xsl:if>
}
function doSubmit()
{
	<xsl:if test="//form/@customSubmit!=''">
	if(<xsl:value-of select="//form/@customSubmit"/>())
	</xsl:if> 
	{
...
<BODY marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" background="images/bg_content.gif" onLoad="doOnload();" onUnload="topClose();" onFocus="topOnFocus(null, '');" onHelp="topEnter('pf1');return false;">
	...
	<xsl:template match="pageinfo">
		<TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
			<TR><TD width="20" height="10"/></TR>
			<TR><TD/><TD>
				<TABLE border="0" class="tableinfo" width="152">					
	...
	<!-- SpecialInfo -->
	<xsl:template match="specialinfo">
		<TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
			<TR>
				<TD width="20"/>
				<TD><A href="javascript:topPrintScreen()"><IMG src="images/ico_printscreen.gif" border="0"/></A></TD>
				<TD width="21"/>
				<TD><A href="javascript:topDMS()"><IMG src="images/ico_DMS.gif" border="0"/></A></TD>
				<TD width="22"/>
				<TD><A href="javascript:topBold()"><IMG src="images/ico_bold_minus.gif" border="0"/></A></TD>
				<TD width="10"/>
				<TD><A href="javascript:topZoom()"><IMG src="images/ico_zoom_minus.gif" border="0"/></A></TD>
				<TD width="20"/>
			</TR>
		</TABLE>
	</xsl:template>
	...
	<!-- PfkeyInfo -->
	<xsl:template match="pfkeyinfo">
		<TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
			<TR><TD width="60" height="10"/><TD/><TD width="60"/></TR>
			<TR><TD></TD><TD>
				<TABLE border="0" class="tableinfo" width="100%">
					<xsl:for-each select="pfkey">
						<xsl:choose>
							<xsl:when test="@ignore='false'">
								<TR><TD align="center">
	...
	<xsl:template match="form">
		...
		<xsl:element name="INPUT">
			<xsl:attribute name="type">hidden</xsl:attribute>
			<xsl:attribute name="name">cmpSession</xsl:attribute>
			<xsl:attribute name="value"><xsl:value-of select="@cmpSession"/></xsl:attribute>
		</xsl:element>
		<xsl:element name="INPUT">
			<xsl:attribute name="type">hidden</xsl:attribute>
		...
		<xsl:element name="INPUT">
			<xsl:attribute name="type">hidden</xsl:attribute>
			<xsl:attribute name="name">printScreen</xsl:attribute>
		...
		<xsl:choose>
			<xsl:when test="@cursor!=''">
				<script language="JavaScript">
					topFocus(document.form.<xsl:value-of select="@cursor"/>);
				</script>
			</xsl:when>
			<xsl:when test="@defaultCursor!=''">
				<script language="JavaScript">
					topFocus(document.form.<xsl:value-of select="@defaultCursor"/>);
				</script>
			</xsl:when>
			<xsl:otherwise>
				<script language="JavaScript">
	...
	<xsl:template match="pfkeylist">
		...
		function topEnter(key) {
			top.document.form.PFKey.value = key;
			if (key != 112 &amp;&amp; key != 117) window.focus();
			if (key == 0) {
			}
		<xsl:for-each select="pfkey">
			<xsl:choose>
				<xsl:when test="@ignore='false'">
					else if (key == <xsl:value-of select="@jsKey"/> || key == '<xsl:value-of select="@name"/>') {
						top.document.form.PFKey.value = '<xsl:value-of select="@jsValue"/>';
	...
	<xsl:template match="line">
	    <TD><TABLE border="0" cellspacing="0" cellpadding="0">
			<TR>
				<xsl:if test="@start>1">
					<TD style="width:{@start*11}px; height:3px"/>
				</xsl:if>
				<TD style="width:{@length*11+11}px; height:3px">
					<IMG src="images/ico_line.gif" width="{@length*11+11}" height="1"/>
				</TD>
			</TR>
		</TABLE></TD>
	</xsl:template>
	...
	<xsl:template match="blank">
		<TD class="txtdis" style="width:{@length*11+11}px">
...
B2;&#x1EB4;&#x1EB6;&#x1EB8;&#x1EBA;&#x1EBC;&#x1EBE;&#x1EC0;&#x1EC2;&#x1EC4;&#x1EC6;&#x1EC8;&#x1ECA;&#x1ECC;&#x1ECE;&#x1ED0;&#x1ED2;&#x1ED4;&#x1ED6;&#x1ED8;&#x1EDA;&#x1EDC;&#x1EDE;&#x1EE0;&#x1EE2;&#x1EE4;&#x1EE6;&#x1EE8;&#x1EEA;&#x1EEC;&#x1EEE;&#x1EF0;&#x1EF2;&#x1EF4;&#x1EF6;&#x1EF8;&#x1F08;&#x1F09;&#x1F0A;&#x1F0B;&#x1F0C;&#x1F0D;&#x1F0E;&#x1F0F;&#x1F18;&#x1F19;&#x1F1A;&#x1F1B;&#x1F1C;&#x1F1D;&#x1F28;&#x1F29;&#x1F2A;&#x1F2B;&#x1F2C;&#x1F2D;&#x1F2E;&#x1F2F;&#x1F38;&#x1F39;&#x1F3A;&#x1F3B;&#x1F3C;&#x1F3D;&#x1F3E;&#x1F3F;&#x1F48;&#x1F49;&#x1F4A;&#x1F4B;&#x1F4C;&#x1F4D;&#x1F59;&#x1F5B;&#x1F5D;&#x1F5F;&#x1F68;&#x1F69;&#x1F6A;&#x1F6B;&#x1F6C;&#x1F6D;&#x1F6E;&#x1F6F;&#x1FBA;&#x1FBB;&#x1FC8;&#x1FC9;&#x1FCA;&#x1FCB;&#x1FDA;&#x1FDB;&#x1FF8;&#x1FF9;&#x1FEA;&#x1FEB;&#x1FFA;&#x1FFB;&#x1F88;&#x1F89;&#x1F8A;&#x1F8B;&#x1F8C;&#x1F8D;&#x1F8E;&#x1F8F;&#x1F98;&#x1F99;&#x1F9A;&#x1F9B;&#x1F9C;&#x1F9D;&#x1F9E;&#x1F9F;&#x1FA8;&#x1FA9;&#x1FAA;&#x1FAB;&#x1FAC;&#x1FAD;&#x1FAE;&#x1FAF;&#x1FB8;&#x1FB9;&#x1FBC;&#x0399;&#x1FCC;&#x1FD8;&#x1FD9;&#x1FE8;&#x1FE9;&#x1FEC;&#x1FFC;&#x2160;&#x2161;&#x2162;&#x2163;&#x2164;&#x2165;&#x2166;&#x2167;&#x2168;&#x2169;&#x216A;&#x216B;&#x216C;&#x216D;&#x216E;&#x216F;&#x24B6;&#x24B7;&#x24B8;&#x24B9;&#x24BA;&#x24BB;&#x24BC;&#x24BD;&#x24BE;&#x24BF;&#x24C0;&#x24C1;&#x24C2;&#x24C3;&#x24C4;&#x24C5;&#x24C6;&#x24C7;&#x24C8;&#x24C9;&#x24CA;&#x24CB;&#x24CC;&#x24CD;&#x24CE;&#x24CF;&#xFF21;&#xFF22;&#xFF23;&#xFF24;&#xFF25;&#xFF26;&#xFF27;&#xFF28;&#xFF29;&#xFF2A;&#xFF2B;&#xFF2C;&#xFF2D;&#xFF2E;&#xFF2F;&#xFF30;&#xFF31;&#xFF32;&#xFF33;&#xFF34;&#xFF35;&#xFF36;&#xFF37;&#xFF38;&#xFF39;&#xFF3A;&#x10400;&#x10401;&#x10402;&#x10403;&#x10404;&#x10405;&#x10406;&#x10407;&#x10408;&#x10409;&#x1040A;&#x1040B;&#x1040C;&#x1040D;&#x1040E;&#x1040F;&#x10410;&#x10411;&#x10412;&#x10413;&#x10414;&#x10415;&#x10416;&#x10417;&#x10418;&#x10419;&#x1041A;&#x1041B;&#x1041C;&#x1041D;&#x1041E;&#x1041F;&#x10420;&#x10421;&#x10422;&#x10423;&#x10424;&#x10425;'"/>
	...
	<xsl:template name="fillStyle">
		<xsl:param name="type"/>
		<xsl:choose>
			<xsl:when test="$type='label' and @highlighting='reverse'">width:<xsl:value-of select="@length*11+11"/>px;<xsl:choose>					
					<xsl:when test="@color='green'">background-color:#00C000;color:black;font-weight:bold;</xsl:when>
					<xsl:when test="@color='yellow'">background-color:#FFA000;color:black;font-weight:bold;</xsl:when>
					<xsl:when test="@color='turquoise'">background-color:#C0C0C0;color:black;font-weight:bold;</xsl:when>
					<xsl:when test="@color='blue'">background-color:#4040FF;color:black;font-weight:bold;</xsl:when>
					<xsl:when test="@color='red'">background-color:#FF0000;color:black;font-weight:bold;</xsl:when>
					<xsl:when test="@color='pink'">background-color:#FF00FF;color:black;font-weight:bold;</xsl:when>
					<xsl:otherwise>background-color:#C0C0C0;color:black;font-weight:bold;</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="$type='edit' and @highlighting='reverse'">width:<xsl:value-of select="@length*11+8"/>px;<xsl:choose>
			...
			<xsl:when test="$type='label'">width:<xsl:value-of select="@length*11+11"/>px;<xsl:choose>
					<xsl:when test="@color='green'">color:black;</xsl:when>
					<xsl:when test="@color='turquoise'">color:#0000C0;font-weight:bold;</xsl:when>
					<xsl:when test="@color='blue'">color:blue;font-weight:bold;</xsl:when>
					<xsl:when test="@color='red'">color:#FF0000;font-weight:bold;</xsl:when>
					<xsl:when test="@color='pink'">color:#FF00FF;font-weight:bold;</xsl:when>
					<xsl:when test="@color='neutral'">color:#8080FF;font-weight:bold;</xsl:when>
					<xsl:otherwise>color:black;</xsl:otherwise>
				</xsl:choose>	
			</xsl:when>
			<xsl:when test="$type='link' and @highlighting='reverse'">color:black;font-weight:bold;</xsl:when>
			...
			<xsl:otherwise>width:<xsl:value-of select="@length*11+8"/>px;<xsl:choose>					
	...
	<!-- <input 
			...
			size=6 
			maxlength=6 
			onFocus="topOnFocus(this, 'DICMAPS');" 
		...
		<xsl:choose>
				...
				<xsl:choose>
					...
					<xsl:when test="@intensity!='dark' and @type='activeChoice'">
						<xsl:call-template name="activeLabel">
							...
							<xsl:with-param name="link">javascript:topOnActiveChoice(document.form.<xsl:value-of select="@activeChoiceTarget"/>, '<xsl:value-of select="@activeChoiceValue"/>', <xsl:value-of select="@activeChoiceSubmit"/>);</xsl:with-param>
						</xsl:call-template>
					</xsl:when>
			...
			<xsl:when test="@protection='unprotected' or @protection='numeric'">			
				<xsl:if test="@color='red'">
					<xsl:attribute name="style">width:<xsl:value-of select="@length*11+11+12"/>px;</xsl:attribute>
					<xsl:element name="img">
				...
				<xsl:attribute name="style">width:<xsl:value-of select="@length*11+11"/>px;</xsl:attribute>
				<xsl:choose>
					<xsl:when test="@type='checkbox'">
						...
						<xsl:element name="INPUT">
							...
							<xsl:attribute name="onFocus">topOnFocus(this, '<xsl:value-of select="@name"/>');</xsl:attribute>
					...
					<xsl:when test="@type='radio'">
						...
						<xsl:element name="INPUT">
							...
							<xsl:attribute name="value"><xsl:value-of select="@valueOn"/></xsl:attribute>
							<xsl:attribute name="class"><xsl:value-of select="@value"/></xsl:attribute>
							<xsl:if test="@value=@valueOn or (@default='true' and @value='')">
								<xsl:attribute name="checked">true</xsl:attribute>
							</xsl:if>
							<xsl:attribute name="onClick">topOnChange(this);</xsl:attribute>
							<xsl:attribute name="onFocus">topOnFocus(this, '<xsl:value-of select="@name"/>');</xsl:attribute>
							<xsl:attribute name="onKeyup">topOnKeyUp(this);</xsl:attribute>
						</xsl:element>
					</xsl:when>
	...
	<xsl:template match="pfkey">
		<xsl:if test="@logo!='' or logo[@lang=/page/@lang]/@path!='' or logo['FR']/@path!=''">
			<TD>
			<xsl:choose>
				<xsl:when test="@ignore='false'">
					<xsl:element name="a">
						<xsl:choose>
							<xsl:when test="@name='pf1'">
								<xsl:attribute name="href">javascript:topOnFocus(null, '');topEnter('<xsl:value-of select="@name"/>');</xsl:attribute> 
							</xsl:when>
							<xsl:otherwise>
								<xsl:attribute name="href">javascript:topEnter('<xsl:value-of select="@name"/>');</xsl:attribute> 
							</xsl:otherwise>
						</xsl:choose>
						<xsl:attribute name="onMouseOver">topOver('<xsl:value-of select="@name"/>')</xsl:attribute>
						<xsl:attribute name="onMouseOut">topOut('<xsl:value-of select="@name"/>')</xsl:attribute>
						<xsl:element name="img">
							<xsl:choose>
								<xsl:when test="@logo!=''">
									<xsl:attribute name="src"><xsl:value-of select="@logo"/></xsl:attribute>
									<xsl:attribute name="alt"><xsl:value-of select="@display"/></xsl:attribute>
								</xsl:when>
								<xsl:otherwise>
									<xsl:attribute name="src"><xsl:value-of select="logo[@lang=/page/@lang]/@path"/></xsl:attribute>
									<xsl:attribute name="alt"><xsl:value-of select="logo[@lang=/page/@lang]/@display"/></xsl:attribute>
								</xsl:otherwise>
							</xsl:choose>
							<xsl:attribute name="name"><xsl:value-of select="@name"/></xsl:attribute>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:element name="INPUT">
					...
					<xsl:attribute name="style">width:<xsl:value-of select="@length*11"/>px;</xsl:attribute>
				</xsl:element>
			</xsl:otherwise>
		</xsl:choose>
		</xsl:element>
	...
	<!-- replay-info -->
	<xsl:template match="replayInfo">
		<font class="subtit"><xsl:value-of select="/page/@replay"/></font>
		<br/>
		<font class="subtit">(<xsl:value-of select="//form/@name"/>)</font>
	</xsl:template>
