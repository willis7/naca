...
//*****************************************************************************************
    ...
    private boolean IsAllInfoPresent(Node x1, Node x2, boolean ignoreBlankSpaces, boolean checkAttributes, boolean ignoreEmptyNodes) throws Exception {
        ...
        NodeList x2Nodes;                         // Les noeuds de x2 qui ont le m�me nom de x1Node.
        Node x2Node;                              // Un des noeuds fils de x2 avec le m�me nom que x1Node.
        ...
        boolean isTextPresent;                    // Indique si un node texte pr�sent dans x1 est aussi pr�sent dans x2.
...
//************************** On contr�le qu'ils aient les m�mes attributs *****************
            if (checkAttributes)
...
// Les nodes texte doivent �tre dans le m�me ordre.
...
//............. Si on n'a trouv� aucun node texte dans X2 qui corr�sponde ................. 
                if (!isTextPresent) {
...
// Les �l�ments ne doivent pas forc�ment �tre dans le m�me ordre.
            for (n = 0; n < x1.getChildNodes().getLength(); n++) {
                x1Node = x1.getChildNodes().item(n);
                ...
                if (x1Node.getChildNodes().getLength() == 0)
                    if (ignoreEmptyNodes)
                        continue;
//............ Il y aura 1 ou plusieurs �l�ments dans x2 avec le m�me nom. .................
...
//............. On en cherche un qui soit identique � x1Node. .............................
