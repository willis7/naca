...
//*************************************************************************
     ...
     * @throws FtpException When the FTP returns an error. Error codes can be
     *                      any of:
     *                      <ul>
     ...
     *                      </ul>
     * @throws Exception    If unexpected errors or communication failure.
     */
...
//*************************************************************************
     ...
     * @throws FtpException if the FTP server returns an error. Error codes
     *                      can be any of:
     *                      <ul>
     *                      <li><b>500</b>:  Syntax error, command unrecognized. This may include errors such as command line too long.</li>
     *                      <li><b>501</b>:  Syntax error in parameters or arguments.</li>
