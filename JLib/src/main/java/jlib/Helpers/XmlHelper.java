...
//*****************************************************************************
//**         Charge un document XML depuis la m�moire.                       **
//*****************************************************************************

    //************************ Depuis une cha�ne qui contient le code XML *********
...
// en caracteres XML.
// La fonction peut �tre appel�e plusieurs fois consecutives
// sur la m�me chaine, la codification aura lieu que la premi�re fois.
...
//............... Remplace les "&" ..........................
// Les "&" sont l�gaux sous la forme "&amp;", "&lt;" et "&gt;"
        n3 = 0;
        n1 = str.indexOf("&");
        while (n1 > 0) {
            n2 = str.indexOf(";", n1);
...
//******************************************************************************
//**                 Contr�le si un node Xml a du contenu.                    **
//******************************************************************************
...
//........................... Cr�ation du nouvel �l�ment ......................
        if (cname.length() > 0) name = cname;
        else name = source.getNodeName();
...
//****************** Si la source est d'un type pas encore implement� ********
            default:
