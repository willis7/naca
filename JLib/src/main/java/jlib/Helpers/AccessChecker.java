...
//************************************************************************************************
     ...
     * @throws Exception if the specified <code>userName</code> already exists.
     * @throws Exception if any of the specified groups in the <code>groupsList</code> parameter isn't declared.
     */
...
//*************************************************************************************************
     ...
     *                 list of group names as: <pre>"users,administrators,backup"</pre>
     * @throws Exception if the specified <code>userName</code> isn't declared.
     * @throws Exception if any of the specified groups in the <code>groups</code> parameter isn't declared.
     */
...
//*************************************************************************************************
     ...
     * @throws Exception If specified name is null or empty.
     ...
     * @throws Exception If specified name is null or empty.
     * @throws Exception if the parent group doesn't exist.
     */
...
//********************************************************************************************
     ...
     * @throws Exception if no user has been yet declared.
     * @throws Exception if <code>parameterName</code> is not null, and <code>parameterValue</code> is.
     * @throws Exception if <code>functionPath</code> is empty or null.
     * @throws Exception if <code>usersOrGroups</code> is empty or null.
     * @throws Exception if <code>usersOrGroups</code> contains undeclared users or groups.
     */
...
//********************************************************************************************
     ...
     * @throws Exception if no user has been yet declared.
     * @throws Exception if <code>parameterName</code> is not null, and <code>parameterValue</code> is.
     * @throws Exception if <code>action</code> is not one of the allowed values.
     * @throws Exception if <code>functionName</code> is empty or null.
     * @throws Exception if <code>usersOrGroups</code> is empty or null.
     * @throws Exception if <code>usersOrGroups</code> contains undeclared users or groups.
     */
...
//***********************************************************************************************
     ...
     * @throws If <code>functionPath</code> is null or empty.
     */
     ...
     * @throws If <code>functionPath</code> is null or empty.
     * @throws If <code>parameterValue</code> is null or empty but <code>parameterName</code> is
     *            not empty.
     */
