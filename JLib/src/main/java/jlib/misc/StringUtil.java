...
//	******************* Copie chaque groupe de chiffre dans le bon compteur *****************************
        boolean bThereIsDate = false;      // Indique qu'il y � effectivement quelque chose d'assimilable a une date
        for (int n = 0; n < nn; n++) {
            bThereIsDate = true;
...
//	****************************** Construit la date ***************************************
        if (bThereIsDate) {
            Calendar d = new GregorianCalendar();    // Date represent�e par s.
