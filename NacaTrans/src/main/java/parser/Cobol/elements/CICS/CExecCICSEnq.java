 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class CExecCICSEnq extends CCobolElement
{

	/**
	 * @param line
	 */
	public CExecCICSEnq(int line)
	{
		super(line);
	}
	...
	protected boolean DoParsing()
	{
		...
		if (tok.GetKeyword() == CCobolKeywordList.ENQ)
		{
			tok = GetNext();
		}
		...
		{
			Transcoder.logError(getLine(), "Error while parsing EXEC CICS ENQ");
			return false ;
		}
		StepNext();
		return true ;
